...
export default function paymentSuccessful() {
  return (
    <div className="flex flex-col flex-1 items-center justify-center bg-white font-sans">
      <main className="flex flex-1 w-full max-w-3xl flex-col items-center justify-between py-32 px-15 bg-zinc-50 sm:items-start">
        ...
        <div className="flex flex-col w-full justify-center items-center">
          ...
          <div className="flex flex-col bg-white rounded-lg border border-gray-300 p-5 w-full justify-center items-center text-center mt-10 space-y-4">
            ...
            <h2 className="text-2xl font-bold text-black mt-10">Payment Successful!</h2>
            <p className="text-lg mt-4 text-black">Thank you for your support! Your payment has been processed successfully.</p>
          </div>
        </div>
